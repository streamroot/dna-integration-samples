...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/PlayKitProviders/PlayKitProviders.framework"
  ...
  install_framework "${PODS_ROOT}/StreamrootSDK/Carthage/Build/iOS/StreamrootSDK.framework"
  install_dsym "${PODS_ROOT}/StreamrootSDK/Carthage/Build/iOS/StreamrootSDK.framework.dSYM"

...
class AppDelegate: UIResponder, UIApplicationDelegate, TVApplicationControllerDelegate, PlayerJSBridge {
  ...
  func executeRemoteMethod(_ methodName: String, withArgs args: [String], completion: @escaping (Bool) -> Void) {
      appController?.evaluate(inJavaScriptContext: { (context: JSContext) in
          ...
          if appObject.hasProperty(methodName) {
              appObject.invokeMethod(methodName, withArguments: [args])
          }
    ...
    func applicationDidEnterBackground(_ application: UIApplication) {
        ...
        executeRemoteMethod("onDidEnterBackground", withArgs: [], completion: { (success: Bool) in
            // ...
        })
    }
    ...
    func applicationWillEnterForeground(_ application: UIApplication) {
        ...
        executeRemoteMethod("onWillEnterForeground", withArgs: [], completion: { (success: Bool) in
            // ...
        })
    }
    ...
    func applicationDidBecomeActive(_ application: UIApplication) {
        ...
        executeRemoteMethod("onDidBecomeActive", withArgs: [], completion: { (success: Bool) in
            // ...
        })
    }
    ...
    func applicationWillTerminate(_ application: UIApplication) {
        ...
        executeRemoteMethod("onWillTerminate", withArgs: [], completion: { (success: Bool) in
            // ...
        })
    }
    ...
    func appController(_ appController: TVApplicationController, didFinishLaunching options: [String: Any]?) {
      ...
      appController.evaluate(inJavaScriptContext: { jsContext in
        jsContext.setObject(self.playerHandler, forKeyedSubscript: self.playerHandler.key())
      }, completion: nil)
    }
